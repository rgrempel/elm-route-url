...
Elm.Result.Extra.make = function (_elm) {
   ...
   var extract = F2(function (f,x) {    var _p1 = x;if (_p1.ctor === "Ok") {    return _p1._0;} else {    return f(_p1._0);}});
   var isErr = function (x) {    var _p2 = x;if (_p2.ctor === "Ok") {    return false;} else {    return true;}};
   var isOk = function (x) {    var _p3 = x;if (_p3.ctor === "Ok") {    return true;} else {    return false;}};
   return _elm.Result.Extra.values = {_op: _op,isOk: isOk,isErr: isErr,extract: extract,withDefault: withDefault,combine: combine};
};
Elm.Native = Elm.Native || {};
Elm.Native.History = {};
...
Elm.Example1 = Elm.Example1 || {};
Elm.Example1.Counter = Elm.Example1.Counter || {};
Elm.Example1.Counter.make = function (_elm) {
   "use strict";
   _elm.Example1 = _elm.Example1 || {};
   _elm.Example1.Counter = _elm.Example1.Counter || {};
   if (_elm.Example1.Counter.values) return _elm.Example1.Counter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var delta2update = F2(function (previous,current) {    return $Maybe.Just($RouteHash.set(_U.list([$Basics.toString(current)])));});
   var title = "Counter";
   ...
   var location2action = function (list) {
      var _p1 = list;
      if (_p1.ctor === "::") {
            var _p2 = $String.toInt(_p1._0);
            if (_p2.ctor === "Ok") {
                  return _U.list([Set(_p2._0)]);
               } else {
                  return _U.list([]);
               }
         } else {
   ...
   var init = 0;
   return _elm.Example1.Counter.values = {_op: _op
                                         ,init: init
                                         ,Increment: Increment
                                         ,Decrement: Decrement
                                         ,Set: Set
...
Elm.Example2 = Elm.Example2 || {};
Elm.Example2.Counter = Elm.Example2.Counter || {};
Elm.Example2.Counter.make = function (_elm) {
   "use strict";
   _elm.Example2 = _elm.Example2 || {};
   _elm.Example2.Counter = _elm.Example2.Counter || {};
   if (_elm.Example2.Counter.values) return _elm.Example2.Counter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.Example2.Counter.values = {_op: _op,init: init,update: update,view: view,delta2update: delta2update,location2action: location2action};
};
Elm.Example2 = Elm.Example2 || {};
Elm.Example2.CounterPair = Elm.Example2.CounterPair || {};
Elm.Example2.CounterPair.make = function (_elm) {
   "use strict";
   _elm.Example2 = _elm.Example2 || {};
   _elm.Example2.CounterPair = _elm.Example2.CounterPair || {};
   if (_elm.Example2.CounterPair.values) return _elm.Example2.CounterPair.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Example2$Counter = Elm.Example2.Counter.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var delta2update = F2(function (previous,current) {
      return $Maybe.Just($RouteHash.set($List.concat(A2($List.map,
      function (_p0) {
         return A2($Maybe.withDefault,_U.list([]),A2($Maybe.map,$RouteHash.extract,_p0));
      },
      _U.list([A2($Example2$Counter.delta2update,previous.topCounter,current.topCounter)
              ,A2($Example2$Counter.delta2update,previous.bottomCounter,current.bottomCounter)])))));
   });
   var title = "Pair of Counters";
   var Bottom = function (a) {    return {ctor: "Bottom",_0: a};};
   var Top = function (a) {    return {ctor: "Top",_0: a};};
   var location2action = function (list) {
      var _p1 = list;
      if (_p1.ctor === "::" && _p1._1.ctor === "::") {
            return $List.concat(_U.list([A2($List.map,Top,$Example2$Counter.location2action(_U.list([_p1._0])))
                                        ,A2($List.map,Bottom,$Example2$Counter.location2action(_U.list([_p1._1._0])))]));
         } else {
            return _U.list([]);
         }
   };
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Example2$Counter.view,A2($Signal.forwardTo,address,Top),model.topCounter)
              ,A2($Example2$Counter.view,A2($Signal.forwardTo,address,Bottom),model.bottomCounter)
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,Reset)]),_U.list([$Html.text("RESET")]))]));
   });
   var init = {topCounter: $Example2$Counter.init(0),bottomCounter: $Example2$Counter.init(0)};
   var update = F2(function (action,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "Reset": return init;
         case "Top": return _U.update(model,{topCounter: A2($Example2$Counter.update,_p2._0,model.topCounter)});
         default: return _U.update(model,{bottomCounter: A2($Example2$Counter.update,_p2._0,model.bottomCounter)});}
   });
   var Model = F2(function (a,b) {    return {topCounter: a,bottomCounter: b};});
   return _elm.Example2.CounterPair.values = {_op: _op
                                             ,Model: Model
                                             ,init: init
                                             ,Reset: Reset
                                             ,Top: Top
...
Elm.Example3 = Elm.Example3 || {};
Elm.Example3.Counter = Elm.Example3.Counter || {};
Elm.Example3.Counter.make = function (_elm) {
   "use strict";
   _elm.Example3 = _elm.Example3 || {};
   _elm.Example3.Counter = _elm.Example3.Counter || {};
   if (_elm.Example3.Counter.values) return _elm.Example3.Counter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var init = function (count) {    return count;};
   return _elm.Example3.Counter.values = {_op: _op,init: init,update: update,view: view};
};
Elm.Example3 = Elm.Example3 || {};
Elm.Example3.CounterList = Elm.Example3.CounterList || {};
Elm.Example3.CounterList.make = function (_elm) {
   "use strict";
   _elm.Example3 = _elm.Example3 || {};
   _elm.Example3.CounterList = _elm.Example3.CounterList || {};
   if (_elm.Example3.CounterList.values) return _elm.Example3.CounterList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Example3$Counter = Elm.Example3.Counter.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var _op = {};
   var delta2update = F2(function (previous,current) {
      return $Maybe.Just($RouteHash.set(A2($List.map,function (_p0) {    return $Basics.toString($Basics.snd(_p0));},current.counters)));
   });
   var title = "List of Counters";
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "Insert": var newCounter = {ctor: "_Tuple2",_0: model.nextID,_1: $Example3$Counter.init(0)};
         ...
         case "Modify": var updateCounter = function (_p2) {
              var _p3 = _p2;
              var _p5 = _p3._1;
              var _p4 = _p3._0;
              return _U.eq(_p4,_p1._0) ? {ctor: "_Tuple2",_0: _p4,_1: A2($Example3$Counter.update,_p1._1,_p5)} : {ctor: "_Tuple2",_0: _p4,_1: _p5};
           };
           return _U.update(model,{counters: A2($List.map,updateCounter,model.counters)});
         default: var counters = A2($List.indexedMap,
           F2(function (index,item) {    return {ctor: "_Tuple2",_0: index,_1: $Example3$Counter.init(item)};}),
           _p1._0);
           return {counters: counters,nextID: $List.length(counters)};}
   });
   var Set = function (a) {    return {ctor: "Set",_0: a};};
   var location2action = function (list) {
      var result = $Result$Extra.combine(A2($List.map,$String.toInt,list));
      var _p6 = result;
      if (_p6.ctor === "Ok") {
            return _U.list([Set(_p6._0)]);
         } else {
            return _U.list([]);
         }
   };
   var Modify = F2(function (a,b) {    return {ctor: "Modify",_0: a,_1: b};});
   var viewCounter = F2(function (address,_p7) {    var _p8 = _p7;return A2($Example3$Counter.view,A2($Signal.forwardTo,address,Modify(_p8._0)),_p8._1);});
   var Remove = {ctor: "Remove"};
   var Insert = {ctor: "Insert"};
   var view = F2(function (address,model) {
   ...
   return _elm.Example3.CounterList.values = {_op: _op
                                             ,Model: Model
                                             ,init: init
                                             ,Insert: Insert
                                             ,Remove: Remove
...
Elm.Example4 = Elm.Example4 || {};
Elm.Example4.Counter = Elm.Example4.Counter || {};
Elm.Example4.Counter.make = function (_elm) {
   "use strict";
   _elm.Example4 = _elm.Example4 || {};
   _elm.Example4.Counter = _elm.Example4.Counter || {};
   if (_elm.Example4.Counter.values) return _elm.Example4.Counter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var init = function (count) {    return count;};
   return _elm.Example4.Counter.values = {_op: _op,init: init,update: update,view: view,viewWithRemoveButton: viewWithRemoveButton,Context: Context};
};
Elm.Example4 = Elm.Example4 || {};
Elm.Example4.CounterList = Elm.Example4.CounterList || {};
Elm.Example4.CounterList.make = function (_elm) {
   "use strict";
   _elm.Example4 = _elm.Example4 || {};
   _elm.Example4.CounterList = _elm.Example4.CounterList || {};
   if (_elm.Example4.CounterList.values) return _elm.Example4.CounterList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Example4$Counter = Elm.Example4.Counter.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var title = "List of Counters (individually removable)";
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "Insert": return _U.update(model,
           {counters: A2($List._op["::"],{ctor: "_Tuple2",_0: model.nextID,_1: $Example4$Counter.init(0)},model.counters),nextID: model.nextID + 1});
         case "Remove": return _U.update(model,{counters: A2($List.filter,function (_p2) {    var _p3 = _p2;return !_U.eq(_p3._0,_p1._0);},model.counters)});
         case "Modify": var updateCounter = function (_p4) {
              var _p5 = _p4;
              var _p7 = _p5._1;
              var _p6 = _p5._0;
              return _U.eq(_p6,_p1._0) ? {ctor: "_Tuple2",_0: _p6,_1: A2($Example4$Counter.update,_p1._1,_p7)} : {ctor: "_Tuple2",_0: _p6,_1: _p7};
           };
           return _U.update(model,{counters: A2($List.map,updateCounter,model.counters)});
         default: var counters = A2($List.indexedMap,
           F2(function (index,item) {    return {ctor: "_Tuple2",_0: index,_1: $Example4$Counter.init(item)};}),
           _p1._0);
           return {counters: counters,nextID: $List.length(counters)};}
   });
   var Set = function (a) {    return {ctor: "Set",_0: a};};
   ...
   var viewCounter = F2(function (address,_p9) {
      var _p10 = _p9;
      var _p11 = _p10._0;
      var context = A2($Example4$Counter.Context,A2($Signal.forwardTo,address,Modify(_p11)),A2($Signal.forwardTo,address,$Basics.always(Remove(_p11))));
      return A2($Example4$Counter.viewWithRemoveButton,context,_p10._1);
   });
   var Insert = {ctor: "Insert"};
   var view = F2(function (address,model) {
      var insert = A2($Html.button,_U.list([A2($Html$Events.onClick,address,Insert)]),_U.list([$Html.text("Add")]));
   ...
   var init = {counters: _U.list([]),nextID: 0};
   var Model = F2(function (a,b) {    return {counters: a,nextID: b};});
   return _elm.Example4.CounterList.values = {_op: _op
                                             ,Model: Model
                                             ,init: init
                                             ,Insert: Insert
                                             ,Remove: Remove
...
Elm.Example5 = Elm.Example5 || {};
Elm.Example5.RandomGif = Elm.Example5.RandomGif || {};
Elm.Example5.RandomGif.make = function (_elm) {
   "use strict";
   _elm.Example5 = _elm.Example5 || {};
   _elm.Example5.RandomGif = _elm.Example5.RandomGif || {};
   if (_elm.Example5.RandomGif.values) return _elm.Example5.RandomGif.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var NewGifFromLocation = function (a) {    return {ctor: "NewGifFromLocation",_0: a};};
   var location2action = function (list) {
      var _p0 = list;
      if (_p0.ctor === "::") {
            return _U.list([NewGifFromLocation(_p0._0)]);
         } else {
            return _U.list([]);
         }
   };
   ...
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "RequestMore": return {ctor: "_Tuple2",_0: _U.update(model,{requestStatus: Use}),_1: getRandomGif(model.topic)};
         case "NewGif": var _p2 = model.requestStatus;
           if (_p2.ctor === "Use") {
                 return {ctor: "_Tuple2",_0: _U.update(model,{gifUrl: A2($Maybe.withDefault,model.gifUrl,_p1._0)}),_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              }
         default: return {ctor: "_Tuple2",_0: _U.update(model,{gifUrl: _p1._0,requestStatus: Ignore}),_1: $Effects.none};}
   });
   var Model = F3(function (a,b,c) {    return {topic: a,gifUrl: b,requestStatus: c};});
   var init = {ctor: "_Tuple2",_0: A3(Model,"funny cats","assets/waiting.gif",Use),_1: getRandomGif("funny cats")};
   var delta2update = F2(function (previous,current) {
      return _U.eq(current.gifUrl,$Basics.fst(init).gifUrl) ? $Maybe.Nothing : $Maybe.Just($RouteHash.set(_U.list([current.gifUrl])));
   });
   return _elm.Example5.RandomGif.values = {_op: _op
                                           ,Model: Model
                                           ,Use: Use
                                           ,Ignore: Ignore
                                           ,init: init
                                           ...
                                           ,NewGif: NewGif
                                           ,NewGifFromLocation: NewGifFromLocation
                                           ,update: update
                                           ,view: view
...
Elm.Example6 = Elm.Example6 || {};
Elm.Example6.RandomGif = Elm.Example6.RandomGif || {};
Elm.Example6.RandomGif.make = function (_elm) {
   "use strict";
   _elm.Example6 = _elm.Example6 || {};
   _elm.Example6.RandomGif = _elm.Example6.RandomGif || {};
   if (_elm.Example6.RandomGif.values) return _elm.Example6.RandomGif.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var _op = {};
   var delta2update = F2(function (previous,current) {
      return _U.eq(current.gifUrl,"assets/waiting.gif") ? $Maybe.Nothing : $Maybe.Just($RouteHash.set(_U.list([current.gifUrl])));
   });
   var decodeUrl = A2($Json$Decode.at,_U.list(["data","image_url"]),$Json$Decode.string);
   _op["=>"] = F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};});
   var headerStyle = $Html$Attributes.style(_U.list([A2(_op["=>"],"width","200px"),A2(_op["=>"],"text-align","center")]));
   ...
   var Model = F3(function (a,b,c) {    return {topic: a,gifUrl: b,requestStatus: c};});
   var init = function (topic) {    return {ctor: "_Tuple2",_0: A3(Model,topic,"assets/waiting.gif",Use),_1: getRandomGif(topic)};};
   return _elm.Example6.RandomGif.values = {_op: _op
                                           ,Model: Model
                                           ,Use: Use
                                           ,Ignore: Ignore
                                           ,init: init
...
Elm.Example6 = Elm.Example6 || {};
Elm.Example6.RandomGifPair = Elm.Example6.RandomGifPair || {};
Elm.Example6.RandomGifPair.make = function (_elm) {
   "use strict";
   _elm.Example6 = _elm.Example6 || {};
   _elm.Example6.RandomGifPair = _elm.Example6.RandomGifPair || {};
   if (_elm.Example6.RandomGifPair.values) return _elm.Example6.RandomGifPair.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Example6$RandomGif = Elm.Example6.RandomGif.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var _op = {};
   var delta2update = F2(function (previous,current) {
      var right = A2($Maybe.map,$RouteHash.extract,A2($Example6$RandomGif.delta2update,previous.right,current.right));
      var left = A2($Maybe.map,$RouteHash.extract,A2($Example6$RandomGif.delta2update,previous.left,current.left));
      return A2($Maybe.map,
      $RouteHash.set,
      A2($Maybe.andThen,left,function (l) {    return A2($Maybe.andThen,right,function (r) {    return $Maybe.Just(A2($Basics._op["++"],l,r));});}));
   });
   var title = "Pair of Random Gifs";
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Example6$RandomGif.view,A2($Signal.forwardTo,address,Left),model.left)
              ,A2($Example6$RandomGif.view,A2($Signal.forwardTo,address,Right),model.right)]));
   });
   var location2action = function (list) {
      var _p0 = list;
      if (_p0.ctor === "::" && _p0._1.ctor === "::") {
            return $List.concat(_U.list([A2($List.map,Left,$Example6$RandomGif.location2action(_U.list([_p0._0])))
                                        ,A2($List.map,Right,$Example6$RandomGif.location2action(_U.list([_p0._1._0])))]));
         } else {
            return _U.list([]);
         }
   };
   ...
   var init = function () {
      var rightTopic = "funny dogs";
      var _p1 = $Example6$RandomGif.init(rightTopic);
      var right = _p1._0;
      var rightFx = _p1._1;
      var leftTopic = "funny cats";
      var _p2 = $Example6$RandomGif.init(leftTopic);
      var left = _p2._0;
      var leftFx = _p2._1;
   ...
   var update = F2(function (action,model) {
      var _p3 = action;
      if (_p3.ctor === "Left") {
            var _p4 = A2($Example6$RandomGif.update,_p3._0,model.left);
            var left = _p4._0;
            var fx = _p4._1;
            return {ctor: "_Tuple2",_0: A2(Model,left,model.right),_1: A2($Effects.map,Left,fx)};
         } else {
            var _p5 = A2($Example6$RandomGif.update,_p3._0,model.right);
            var right = _p5._0;
            var fx = _p5._1;
            return {ctor: "_Tuple2",_0: A2(Model,model.left,right),_1: A2($Effects.map,Right,fx)};
         }
   });
   return _elm.Example6.RandomGifPair.values = {_op: _op
                                               ,Model: Model
                                               ,init: init
                                               ,Left: Left
                                               ,Right: Right
...
Elm.Example7 = Elm.Example7 || {};
Elm.Example7.RandomGif = Elm.Example7.RandomGif || {};
Elm.Example7.RandomGif.make = function (_elm) {
   "use strict";
   _elm.Example7 = _elm.Example7 || {};
   _elm.Example7.RandomGif = _elm.Example7.RandomGif || {};
   if (_elm.Example7.RandomGif.values) return _elm.Example7.RandomGif.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var encodeLocation = function (model) {
      return _U.eq(model.gifUrl,$Maybe.Nothing) ? $Maybe.Nothing : $Maybe.Just(_U.list([model.topic,A2($Maybe.withDefault,"",model.gifUrl)]));
   };
   var decodeUrl = A2($Json$Decode.at,_U.list(["data","image_url"]),$Json$Decode.string);
   _op["=>"] = F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};});
   var headerStyle = $Html$Attributes.style(_U.list([A2(_op["=>"],"width","200px"),A2(_op["=>"],"text-align","center")]));
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],"width","200px")]))]),
      _U.list([A2($Html.h2,_U.list([headerStyle]),_U.list([$Html.text(model.topic)]))
              ,A2($Html.div,_U.list([imgStyle(A2($Maybe.withDefault,"assets/waiting.gif",model.gifUrl))]),_U.list([]))
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,RequestMore)]),_U.list([$Html.text("More Please!")]))]));
   });
   var Model = F2(function (a,b) {    return {topic: a,gifUrl: b};});
   var init = F2(function (topic,gifUrl) {
      return {ctor: "_Tuple2",_0: A2(Model,topic,gifUrl),_1: _U.eq(gifUrl,$Maybe.Nothing) ? getRandomGif(topic) : $Effects.none};
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "RequestMore") {
            ...
            return {ctor: "_Tuple2",_0: A2(Model,model.topic,$Maybe.oneOf(_U.list([_p0._0,model.gifUrl]))),_1: $Effects.none};
         }
   });
   return _elm.Example7.RandomGif.values = {_op: _op
                                           ,Model: Model
                                           ,init: init
                                           ,RequestMore: RequestMore
                                           ,NewGif: NewGif
...
Elm.Example7 = Elm.Example7 || {};
Elm.Example7.RandomGifList = Elm.Example7.RandomGifList || {};
Elm.Example7.RandomGifList.make = function (_elm) {
   "use strict";
   _elm.Example7 = _elm.Example7 || {};
   _elm.Example7.RandomGifList = _elm.Example7.RandomGifList || {};
   if (_elm.Example7.RandomGifList.values) return _elm.Example7.RandomGifList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Example7$RandomGif = Elm.Example7.RandomGif.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var inTwos = function (list) {
      var step = F2(function (sublist,result) {
         step: while (true) {
            var _p0 = sublist;
            if (_p0.ctor === "::" && _p0._1.ctor === "::") {
                  var _v1 = _p0._1._1,_v2 = A2($List._op["::"],{ctor: "_Tuple2",_0: _p0._0,_1: _p0._1._0},result);
                  sublist = _v1;
                  result = _v2;
                  continue step;
               } else {
      ...
      return $List.reverse(A2(step,list,_U.list([])));
   };
   var delta2update = F2(function (previous,current) {
      return $Maybe.Just($RouteHash.set($List.concat(A2($List.filterMap,
      function (_p1) {
         return $Example7$RandomGif.encodeLocation($Basics.snd(_p1));
      },
      current.gifList))));
   });
   var title = "List of Random Gifs";
   ...
   var Set = function (a) {    return {ctor: "Set",_0: a};};
   var location2action = function (list) {
      return _U.list([Set(A2($List.map,
      function (_p3) {
         var _p4 = _p3;
         var _p6 = _p4._1;
         var _p5 = _p4._0;
         return _U.eq(_p6,"") ? {ctor: "_Tuple2",_0: _p5,_1: $Maybe.Nothing} : {ctor: "_Tuple2",_0: _p5,_1: $Maybe.Just(_p6)};
      },
      inTwos(list)))]);
   };
   var SubMsg = F2(function (a,b) {    return {ctor: "SubMsg",_0: a,_1: b};});
   var elementView = F2(function (address,_p7) {    var _p8 = _p7;return A2($Example7$RandomGif.view,A2($Signal.forwardTo,address,SubMsg(_p8._0)),_p8._1);});
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.placeholder("What kind of gifs do you want?")
                      ...
                      ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p9) {    return A2($Signal.message,address,Topic(_p9));})
                      ,inputStyle]),
              _U.list([]))
              ,A2($Html.div,
   ...
   var update = F2(function (message,model) {
      var _p10 = message;
      switch (_p10.ctor)
      {case "Topic": return {ctor: "_Tuple2",_0: _U.update(model,{topic: _p10._0}),_1: $Effects.none};
         case "Create": var _p11 = A2($Example7$RandomGif.init,model.topic,$Maybe.Nothing);
           var newRandomGif = _p11._0;
           var fx = _p11._1;
         ...
         case "SubMsg": var subUpdate = function (_p12) {
              var _p13 = _p12;
              var _p15 = _p13._0;
              if (_U.eq(_p15,_p10._0)) {
                    var _p14 = A2($Example7$RandomGif.update,_p10._1,_p13._1);
                    var newRandomGif = _p14._0;
                    var fx = _p14._1;
                    return {ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: _p15,_1: newRandomGif},_1: A2($Effects.map,SubMsg(_p15),fx)};
                 } else return {ctor: "_Tuple2",_0: _p13,_1: $Effects.none};
           };
           var _p16 = $List.unzip(A2($List.map,subUpdate,model.gifList));
           var newGifList = _p16._0;
           var fxList = _p16._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{gifList: newGifList}),_1: $Effects.batch(fxList)};
         default: var inits = A2($List.map,function (_p17) {    var _p18 = _p17;return A2($Example7$RandomGif.init,_p18._0,_p18._1);},_p10._0);
           var modelsAndEffects = A2($List.indexedMap,
           F2(function (index,item) {
              return {ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: index,_1: $Basics.fst(item)},_1: A2($Effects.map,SubMsg(index),$Basics.snd(item))};
           }),
           inits);
           var _p19 = $List.unzip(modelsAndEffects);
           var models = _p19._0;
           var effects = _p19._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{gifList: models,uid: $List.length(models)}),_1: $Effects.batch(effects)};}
   });
   return _elm.Example7.RandomGifList.values = {_op: _op
                                               ,Model: Model
                                               ,init: init
                                               ,Topic: Topic
                                               ,Create: Create
...
Elm.Example8 = Elm.Example8 || {};
Elm.Example8.SpinSquare = Elm.Example8.SpinSquare || {};
Elm.Example8.SpinSquare.make = function (_elm) {
   "use strict";
   _elm.Example8 = _elm.Example8 || {};
   _elm.Example8.SpinSquare = _elm.Example8.SpinSquare || {};
   if (_elm.Example8.SpinSquare.values) return _elm.Example8.SpinSquare.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var delta2update = function (current) {
      return _U.eq(current.animationState,$Maybe.Nothing) ? $Maybe.Just($Basics.toString(current.angle)) : $Maybe.Nothing;
   };
   var SetAngle = function (a) {    return {ctor: "SetAngle",_0: a};};
   var location2action = function (location) {    return A2($Maybe.map,SetAngle,$Result.toMaybe($String.toFloat(location)));};
   var Tick = function (a) {    return {ctor: "Tick",_0: a};};
   var Spin = {ctor: "Spin"};
   ...
   var update = F2(function (msg,model) {
      var _p0 = msg;
      switch (_p0.ctor)
      {case "Spin": var _p1 = model.animationState;
           if (_p1.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.tick(Tick)};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              }
         case "Tick": var _p3 = _p0._0;
         ...
         default: return {ctor: "_Tuple2",_0: {angle: _p0._0,animationState: $Maybe.Nothing},_1: $Effects.none};}
   });
   ...
   return _elm.Example8.SpinSquare.values = {_op: _op
                                            ,init: init
                                            ,update: update
                                            ,view: view
                                            ,delta2update: delta2update
...
Elm.Example8 = Elm.Example8 || {};
Elm.Example8.SpinSquarePair = Elm.Example8.SpinSquarePair || {};
Elm.Example8.SpinSquarePair.make = function (_elm) {
   "use strict";
   _elm.Example8 = _elm.Example8 || {};
   _elm.Example8.SpinSquarePair = _elm.Example8.SpinSquarePair || {};
   if (_elm.Example8.SpinSquarePair.values) return _elm.Example8.SpinSquarePair.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Example8$SpinSquare = Elm.Example8.SpinSquare.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var _op = {};
   var delta2update = F2(function (previous,current) {
      var right = $Example8$SpinSquare.delta2update(current.right);
      var left = $Example8$SpinSquare.delta2update(current.left);
      return A2($Maybe.andThen,left,function (l) {    return A2($Maybe.andThen,right,function (r) {    return $Maybe.Just($RouteHash.set(_U.list([l,r])));});});
   });
   var title = "Pair of spinning squares";
   _op["=>"] = F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};});
   var Right = function (a) {    return {ctor: "Right",_0: a};};
   var Left = function (a) {    return {ctor: "Left",_0: a};};
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Example8$SpinSquare.view,A2($Signal.forwardTo,address,Left),model.left)
              ,A2($Example8$SpinSquare.view,A2($Signal.forwardTo,address,Right),model.right)]));
   });
   var location2action = function (list) {
      var _p0 = list;
      if (_p0.ctor === "::" && _p0._1.ctor === "::") {
            ...
            $Basics.identity,
            _U.list([A2($Maybe.map,Left,$Example8$SpinSquare.location2action(_p0._0)),A2($Maybe.map,Right,$Example8$SpinSquare.location2action(_p0._1._0))]));
         } else {
            return _U.list([]);
         }
   };
   var Model = F2(function (a,b) {    return {left: a,right: b};});
   var init = function () {
      var _p1 = $Example8$SpinSquare.init;
      var right = _p1._0;
      var rightFx = _p1._1;
      var _p2 = $Example8$SpinSquare.init;
      var left = _p2._0;
      var leftFx = _p2._1;
      return {ctor: "_Tuple2",_0: A2(Model,left,right),_1: $Effects.batch(_U.list([A2($Effects.map,Left,leftFx),A2($Effects.map,Right,rightFx)]))};
   }();
   var update = F2(function (action,model) {
      var _p3 = action;
      if (_p3.ctor === "Left") {
            var _p4 = A2($Example8$SpinSquare.update,_p3._0,model.left);
            var left = _p4._0;
            var fx = _p4._1;
            return {ctor: "_Tuple2",_0: A2(Model,left,model.right),_1: A2($Effects.map,Left,fx)};
         } else {
            var _p5 = A2($Example8$SpinSquare.update,_p3._0,model.right);
            var right = _p5._0;
            var fx = _p5._1;
            return {ctor: "_Tuple2",_0: A2(Model,model.left,right),_1: A2($Effects.map,Right,fx)};
         }
   });
   return _elm.Example8.SpinSquarePair.values = {_op: _op
                                                ,Model: Model
                                                ,init: init
                                                ,Left: Left
                                                ,Right: Right
...
Elm.ExampleViewer = Elm.ExampleViewer || {};
Elm.ExampleViewer.make = function (_elm) {
   "use strict";
   _elm.ExampleViewer = _elm.ExampleViewer || {};
   if (_elm.ExampleViewer.values) return _elm.ExampleViewer.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Example1$Counter = Elm.Example1.Counter.make(_elm),
   $Example2$CounterPair = Elm.Example2.CounterPair.make(_elm),
   $Example3$CounterList = Elm.Example3.CounterList.make(_elm),
   $Example4$CounterList = Elm.Example4.CounterList.make(_elm),
   $Example5$RandomGif = Elm.Example5.RandomGif.make(_elm),
   $Example6$RandomGifPair = Elm.Example6.RandomGifPair.make(_elm),
   $Example7$RandomGifList = Elm.Example7.RandomGifList.make(_elm),
   $Example8$SpinSquarePair = Elm.Example8.SpinSquarePair.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var delta2update = F2(function (previous,current) {
      var _p0 = current.currentExample;
      switch (_p0.ctor)
      {case "Example1": return A2($RouteHash.map,
           F2(function (x,y) {    return A2($List._op["::"],x,y);})("example-1"),
           A2($Example1$Counter.delta2update,previous.example1,current.example1));
         case "Example2": return A2($RouteHash.map,
           F2(function (x,y) {    return A2($List._op["::"],x,y);})("example-2"),
           A2($Example2$CounterPair.delta2update,previous.example2,current.example2));
         case "Example3": return A2($RouteHash.map,
           F2(function (x,y) {    return A2($List._op["::"],x,y);})("example-3"),
           A2($Example3$CounterList.delta2update,previous.example3,current.example3));
         case "Example4": return A2($RouteHash.map,
           F2(function (x,y) {    return A2($List._op["::"],x,y);})("example-4"),
           A2($Example4$CounterList.delta2update,previous.example4,current.example4));
         case "Example5": return A2($RouteHash.map,
           F2(function (x,y) {    return A2($List._op["::"],x,y);})("example-5"),
           A2($Example5$RandomGif.delta2update,previous.example5,current.example5));
         case "Example6": return A2($RouteHash.map,
           F2(function (x,y) {    return A2($List._op["::"],x,y);})("example-6"),
           A2($Example6$RandomGifPair.delta2update,previous.example6,current.example6));
         case "Example7": return A2($RouteHash.map,
           F2(function (x,y) {    return A2($List._op["::"],x,y);})("example-7"),
           A2($Example7$RandomGifList.delta2update,previous.example7,current.example7));
         default: return A2($RouteHash.map,
           F2(function (x,y) {    return A2($List._op["::"],x,y);})("example-8"),
           A2($Example8$SpinSquarePair.delta2update,previous.example8,current.example8));}
   });
   _op["=>"] = F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};});
   var NoOp = {ctor: "NoOp"};
   var ShowExample = function (a) {    return {ctor: "ShowExample",_0: a};};
   var Example8Action = function (a) {    return {ctor: "Example8Action",_0: a};};
   var Example7Action = function (a) {    return {ctor: "Example7Action",_0: a};};
   var Example6Action = function (a) {    return {ctor: "Example6Action",_0: a};};
   var Example5Action = function (a) {    return {ctor: "Example5Action",_0: a};};
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "ShowExample": return {ctor: "_Tuple2",_0: _U.update(model,{currentExample: _p1._0}),_1: $Effects.none};
         case "Example1Action": return {ctor: "_Tuple2",_0: _U.update(model,{example1: A2($Example1$Counter.update,_p1._0,model.example1)}),_1: $Effects.none};
         case "Example2Action": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,{example2: A2($Example2$CounterPair.update,_p1._0,model.example2)})
                                       ,_1: $Effects.none};
         case "Example3Action": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,{example3: A2($Example3$CounterList.update,_p1._0,model.example3)})
                                       ,_1: $Effects.none};
         case "Example4Action": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,{example4: A2($Example4$CounterList.update,_p1._0,model.example4)})
                                       ,_1: $Effects.none};
         case "Example5Action": var result = A2($Example5$RandomGif.update,_p1._0,model.example5);
           return {ctor: "_Tuple2",_0: _U.update(model,{example5: $Basics.fst(result)}),_1: A2($Effects.map,Example5Action,$Basics.snd(result))};
         case "Example6Action": var result = A2($Example6$RandomGifPair.update,_p1._0,model.example6);
           return {ctor: "_Tuple2",_0: _U.update(model,{example6: $Basics.fst(result)}),_1: A2($Effects.map,Example6Action,$Basics.snd(result))};
         case "Example7Action": var result = A2($Example7$RandomGifList.update,_p1._0,model.example7);
           return {ctor: "_Tuple2",_0: _U.update(model,{example7: $Basics.fst(result)}),_1: A2($Effects.map,Example7Action,$Basics.snd(result))};
         default: var result = A2($Example8$SpinSquarePair.update,_p1._0,model.example8);
           return {ctor: "_Tuple2",_0: _U.update(model,{example8: $Basics.fst(result)}),_1: A2($Effects.map,Example8Action,$Basics.snd(result))};}
   });
   var Example4Action = function (a) {    return {ctor: "Example4Action",_0: a};};
   var Example3Action = function (a) {    return {ctor: "Example3Action",_0: a};};
   var Example2Action = function (a) {    return {ctor: "Example2Action",_0: a};};
   var Example1Action = function (a) {    return {ctor: "Example1Action",_0: a};};
   var Model = F9(function (a,b,c,d,e,f,g,h,i) {
      return {example1: a,example2: b,example3: c,example4: d,example5: e,example6: f,example7: g,example8: h,currentExample: i};
   });
   var Example8 = {ctor: "Example8"};
   var Example7 = {ctor: "Example7"};
   var Example6 = {ctor: "Example6"};
   var Example5 = {ctor: "Example5"};
   var Example4 = {ctor: "Example4"};
   var Example3 = {ctor: "Example3"};
   var Example2 = {ctor: "Example2"};
   var Example1 = {ctor: "Example1"};
   var init = function () {
      var effects = $Effects.batch(_U.list([A2($Effects.map,Example5Action,$Basics.snd($Example5$RandomGif.init))
                                           ,A2($Effects.map,Example6Action,$Basics.snd($Example6$RandomGifPair.init))
                                           ,A2($Effects.map,Example7Action,$Basics.snd($Example7$RandomGifList.init))
                                           ,A2($Effects.map,Example8Action,$Basics.snd($Example8$SpinSquarePair.init))]));
      var model = {example1: $Example1$Counter.init
                  ,example2: $Example2$CounterPair.init
                  ,example3: $Example3$CounterList.init
                  ,example4: $Example4$CounterList.init
                  ,example5: $Basics.fst($Example5$RandomGif.init)
                  ,example6: $Basics.fst($Example6$RandomGifPair.init)
                  ,example7: $Basics.fst($Example7$RandomGifList.init)
                  ,example8: $Basics.fst($Example8$SpinSquarePair.init)
                  ,currentExample: Example1};
      return {ctor: "_Tuple2",_0: model,_1: effects};
   }();
   var view = F2(function (address,model) {
      var makeTitle = function (_p2) {
         var _p3 = _p2;
         var _p4 = _p3._1;
      ...
      A2($List.map,
      makeTitle,
      _U.list([{ctor: "_Tuple3",_0: 1,_1: Example1,_2: $Example1$Counter.title}
              ,{ctor: "_Tuple3",_0: 2,_1: Example2,_2: $Example2$CounterPair.title}
              ,{ctor: "_Tuple3",_0: 3,_1: Example3,_2: $Example3$CounterList.title}
              ,{ctor: "_Tuple3",_0: 4,_1: Example4,_2: $Example4$CounterList.title}
              ,{ctor: "_Tuple3",_0: 5,_1: Example5,_2: $Example5$RandomGif.title}
              ,{ctor: "_Tuple3",_0: 6,_1: Example6,_2: $Example6$RandomGifPair.title}
              ,{ctor: "_Tuple3",_0: 7,_1: Example7,_2: $Example7$RandomGifList.title}
              ,{ctor: "_Tuple3",_0: 8,_1: Example8,_2: $Example8$SpinSquarePair.title}])));
      var viewExample = function () {
         var _p5 = model.currentExample;
         switch (_p5.ctor)
         {case "Example1": return A2($Example1$Counter.view,A2($Signal.forwardTo,address,Example1Action),model.example1);
            case "Example2": return A2($Example2$CounterPair.view,A2($Signal.forwardTo,address,Example2Action),model.example2);
            case "Example3": return A2($Example3$CounterList.view,A2($Signal.forwardTo,address,Example3Action),model.example3);
            case "Example4": return A2($Example4$CounterList.view,A2($Signal.forwardTo,address,Example4Action),model.example4);
            case "Example5": return A2($Example5$RandomGif.view,A2($Signal.forwardTo,address,Example5Action),model.example5);
            case "Example6": return A2($Example6$RandomGifPair.view,A2($Signal.forwardTo,address,Example6Action),model.example6);
   ...
   var location2action = function (list) {
      ...
      _v4_8: do {
         if (_p6.ctor === "::") {
               switch (_p6._0)
               {case "example-1": return A2($List._op["::"],ShowExample(Example1),A2($List.map,Example1Action,$Example1$Counter.location2action(_p6._1)));
                  case "example-2": return A2($List._op["::"],ShowExample(Example2),A2($List.map,Example2Action,$Example2$CounterPair.location2action(_p6._1)));
                  case "example-3": return A2($List._op["::"],ShowExample(Example3),A2($List.map,Example3Action,$Example3$CounterList.location2action(_p6._1)));
                  case "example-4": return A2($List._op["::"],ShowExample(Example4),A2($List.map,Example4Action,$Example4$CounterList.location2action(_p6._1)));
                  case "example-5": return A2($List._op["::"],ShowExample(Example5),A2($List.map,Example5Action,$Example5$RandomGif.location2action(_p6._1)));
                  case "example-6": return A2($List._op["::"],
                    ShowExample(Example6),
                    A2($List.map,Example6Action,$Example6$RandomGifPair.location2action(_p6._1)));
                  case "example-7": return A2($List._op["::"],
                    ShowExample(Example7),
                    A2($List.map,Example7Action,$Example7$RandomGifList.location2action(_p6._1)));
                  case "example-8": return A2($List._op["::"],
                    ShowExample(Example8),
                    A2($List.map,Example8Action,$Example8$SpinSquarePair.location2action(_p6._1)));
                  default: break _v4_8;}
            } else {
               break _v4_8;
            }
      } while (false);
      return _U.list([ShowExample(Example1)]);
   };
   return _elm.ExampleViewer.values = {_op: _op
                                      ,Example1: Example1
                                      ,Example2: Example2
                                      ,Example3: Example3
                                      ,Example4: Example4
                                      ...
                                      ,Model: Model
                                      ,init: init
                                      ,Example1Action: Example1Action
                                      ,Example2Action: Example2Action
                                      ,Example3Action: Example3Action
                                      ,Example4Action: Example4Action
                                      ,Example5Action: Example5Action
                                      ,Example6Action: Example6Action
                                      ,Example7Action: Example7Action
                                      ,Example8Action: Example8Action
...
Elm.Main.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $ExampleViewer = Elm.ExampleViewer.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var messages = $Signal.mailbox($ExampleViewer.NoOp);
   var app = $StartApp.start({init: $ExampleViewer.init,update: $ExampleViewer.update,view: $ExampleViewer.view,inputs: _U.list([messages.signal])});
   var main = app.html;
   ...
   return _elm.Main.values = {_op: _op,app: app,messages: messages,main: main};
};
